...
typedef struct
{
	...
	#define OV8825_FULL_X_END						        	(3264+150)     
	...
	#define OV8825_FULL_PERIOD_PIXEL_NUMS					(0x0E30+150) //3632+150 //mt6589 add dummy pixel 150 for line_start/end 
	#if defined(ZSD15FPS)
	...
	#define OV8825_VIDEO_PERIOD_PIXEL_NUMS 				0x0A00	//2560
