...
#define BAR_BG_COLOR        (0x0000)    // Black
	...
	#define CAPACITY_BOTTOM              (1288)

	// first number rectangle
	#define NUMBER_LEFT                  (351) // number
	#define NUMBER_TOP                   (479)
	#define NUMBER_RIGHT                 (435)
	#define NUMBER_BOTTOM                (600)

	// %  rectangle
	#define PERCENT_LEFT                 (519) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (479)
	#define PERCENT_RIGHT                (627)
